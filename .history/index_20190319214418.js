...
let pattern = "Teeeeeeeerazbedziebaaardzodluuuuugitekst"
var possible="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"
let maxPopulationCount = 5;
...
{
  var mutationChild = mutation( child )
  var scoreChild = fittnes( child )
  var scoreMutationChild = fittnes( mutationChild )
  var returnObject = {}

  if( scoreChild < scoreMutationChild)
    returnObject = { "member": mutationChild, "score": scoreMutationChild}
  else
    returnObject = { "member": child, "score": scoreChild }
...
function genetic()
{
  ...
  }while( population[0].score != 1 )

  console.log(iterattion)
